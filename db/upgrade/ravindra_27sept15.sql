...
AS
select BASE.TRANSACTION_ID, BASE.TRANSACTION_NUMBER, BASE.TYPE, BASE.CREATOR, BASE.APPROVER, DTL.TRANSACTION_DTL_ID, DTL.TRANSACTION_VERSION, DTL.TRANSACTION_VALUE, DTL.TRANSACTION_DATE, DTL.BUSINESS_ENTITY_ID, DTL.ISSUING_BANK_ID,
...
CREATE OR REPLACE VIEW XXBFM_TRANSACTION_V
AS
  SELECT DTLV.TRANSACTION_ID,
    DTLV.TRANSACTION_NUMBER,
    DTLV.TYPE,
    DTLV.CREATOR,
    DTLV.APPROVER,
    DTLV.TRANSACTION_DTL_ID,
    DTLV.TRANSACTION_VERSION,
	DTLV.TRANSACTION_VALUE,
    DTLV.TRANSACTION_DATE,
    DTLV.BUSINESS_ENTITY_ID,
    DTLV.ISSUING_BANK_ID,
    DTLV.BENEFICIARY_BANK_ID,
    DTLV.FACILITY_TRACKER_ID,
    DTLV.APPROVAL_STATUS
  FROM XXBFM_TRANSACTION_DETAIL_V DTLV,
    (SELECT TRANSACTION_ID,
      MAX(TRANSACTION_VERSION) TRANSACTION_VERSION
    FROM XXBFM_TRANSACTION_DTL
    GROUP BY TRANSACTION_ID
    ) TRANS_DETAIL_MAX_VERSION
  WHERE DTLV.TRANSACTION_ID=TRANS_DETAIL_MAX_VERSION.TRANSACTION_ID
  AND DTLV.TRANSACTION_VERSION=TRANS_DETAIL_MAX_VERSION.TRANSACTION_VERSION;